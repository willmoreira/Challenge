...
class DetailCharacterUITests: XCTestCase {
    ...
    func testDetailCharacterScreen() throws {
        ...
        XCTAssertTrue(backgroundImageView.waitForExistence(timeout: 5), "A imagem de fundo deve estar visível na tela de detalhes do personagem.")
        
        let imgCharacter = app.images["imgCharacter"]
        XCTAssertTrue(imgCharacter.waitForExistence(timeout: 5), "A imagem de fundo deve estar visível na tela de detalhes do personagem.")
    }
